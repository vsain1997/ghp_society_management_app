...
@section('title', 'Resident Visitors')
...
@section('content')
    <div class="right_main_body_content society_detail_page">
        ...
        <div class="mt-4 bg-card ">
            <div class="society_details">
                <h4 class="text-primary">Visitee Info</h4>
                <br>
                <ul>
                    <li>
                        <p>Visitor Of </p>
        ...
        <div class="mt-4 bg-card ">
            <div class="society_details">
                ...
                <br>
                @if (!empty($visitor->visitorFeedback->feedback))
                    <h4>{{ $visitor->visitorFeedback->feedback }}</h4>
                @else
                    <p class="text-muted" style="text-transform: none">
                        Resident Didn't Provide Any Feedback.
                    </p>
                @endif
            </div>
        </div>
