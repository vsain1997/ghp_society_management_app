...
@section('content')
    <div class="right_main_body_content members_page">
        <div class="head_content">
            <div class="left_head">
                <h2>Service Provider ( <span class="text-muted">External</span> ) </h2>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="hidden" name="statusVal"
                                            value="{{ parseStatus($sprovider->status, 0) }}">
                                        <div class="status_select">
                                            <select name="status" data-id="{{ $sprovider->id }}"
