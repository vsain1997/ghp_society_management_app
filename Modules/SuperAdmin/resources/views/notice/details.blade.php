        ...
        <div class="bg-card">
            <div class="society_details">
                <ul>
                    <li>
                        <p>Society </p>
                        <h4>{{ $notice->society->name }}</h4>
                    </li>
                    <li>
                        <p>Date</p>
                        <h4>{{ \Carbon\Carbon::parse($notice->date)->format('d M Y') }}</h4>
                    </li>
                    <li>
                        <p>Time</p>
                        <h4>{{ \Carbon\Carbon::parse($notice->time)->format('g:i A') }} </h4>
                    </li>
                </ul>
                ...
                <br>
                <p>Description</p>
                <p style="text-transform: none">{{ $notice->description }}</p>
            </div>
        </div>
    </div>
@endsection
