...
<div class="right_main_body_content members_page">
    <div class="head_content">
        ...
        <button type="button" class="bg_theme_btn" id="addNoticeModalOpen" data-bs-toggle="modal"
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ \Carbon\Carbon::parse($notice->time)->format('g:i A') }}</td>
                        <td>
                            @if (strlen($notice->description) > 50)
                            {{ substr($notice->description, 0, 47) . '...' }}
                            @else
                            {{ $notice->description }}
                            @endif
                        </td>
                        ...
                        <td class="text-center">
                            <div class="actions">
                                <a href="javascript:void(0)" id="{{ $notice->id }}" class="edit edit-icon">
                                    <img src="{{ url($thisModule) }}/img/edit.png" alt="edit">
                                </a>
                                <a href="{{ route($thisModule . '.notice.details', ['id' => $notice->id]) }}"
                                    id="{{ $notice->id }}" class="view">
                                    <img src="{{ url($thisModule) }}/img/eye.png" alt="eye">
                                </a>
                                <a href="javascript:void(0)" data-id="{{ $notice->id }}" class="delete delete-icon">
            ...
            <div class="table_bottom_box">
                ...
                <div class="d-flex justify-content-between p-2 mt-2 mb-2">
                    <div>
                        ...
                        {{ $notices->total() }} results
                    </div>
                    <div>
                        {{ $notices->links('vendor.pagination.bootstrap-5') }} {{-- Bootstrap 5 pagination view --}}
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content ">
            <div class="modal-header">
                <h3 class="text-white" id="modalHeadTxt">Add Notice</h3>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="custom-plac">
                                        <input type="date" name="date" id="date" class="form-control remove-date">
                                        <span class="none-plac date-plac">Date</span>
                                    </div>
                                    <span class="text-danger err"></span>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="custom-plac">
                                        <input type="time" name="time" id="time" class="form-control remove-time">
                                        <span class="none-plac time-plac">Time</span>
                                    </div>
                                    <span class="text-danger err"></span>
                                </div>
                            </div>
...
<script>
    $(".members_page").on('click', '#addNoticeModalOpen', function (event) {
        ...
        $('#submitAddNoticeForm').text('Submit');
...
<script>
    $(document).ready(function () {
        $('body').on('click', '.edit', function () {
            ...
            $('#submitAddNoticeForm').text('Update');
    ...
    $(document).ready(function() {
        ...
        $('#searchForm').submit(function(event) {
            ...
            if ((checkinDate && !checkoutDate) || (!checkinDate && checkoutDate)) {
                ...
                if (!checkinDate) {
                    $('#from_date_error').text('Required.');
                }

                if (!checkoutDate) {
                    $('#to_date_error').text('Required.');
                }
            }
        });
    });
