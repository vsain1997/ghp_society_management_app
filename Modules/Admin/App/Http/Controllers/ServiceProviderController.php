...
class ServiceProviderController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:service_provider.view|service_provider.create|service_provider.edit|service_provider.delete|service_provider.change_status')->only(['index', 'show']);
        $this->middleware('permission:service_provider.create')->only(['store']);
        ...
        $this->middleware('permission:service_provider.change_status')->only(['changeStatus']);
    }
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('admin::serviceProvider.serviceProvider', [
