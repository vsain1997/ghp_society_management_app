...
class PollController extends Controller
{
    ...
    {
        $this->middleware('permission:poll.view|poll.create|poll.edit|poll.delete')->only(['index', 'show']);
        $this->middleware('permission:poll.create')->only(['store']);
