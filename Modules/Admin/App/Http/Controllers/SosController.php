...
class SosController extends Controller
{
    ...
    {
        $this->middleware('permission:sos.view | sos.change_status')->only(['index', 'show']);
        $this->middleware('permission:sos.change_status')->only(['changeStatus']);
    }
