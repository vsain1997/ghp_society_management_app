...
<div class="right_main_body_content members_page">
    <div class="head_content">
        <div class="left_head">
            {{-- <h2>Notice Board</h2> --}}
            {{-- <p>Add or manage notices of the society</p> --}}
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            {{-- <div class="actions">
                                <a href="javascript:void(0)" id="{{ $notice->id }}" class="edit-icon">
                                ...
                                <a href="javascript:void(0)" data-id="{{ $notice->id }}" class="delete">
                                    <img src="{{ url($thisModule) }}/img/delete.png" alt="delete">
                                </a>
                            </div> --}}
                            <div class="actions">
                                @can('notice.edit')
                                <a class="edit edit-icon" href="javascript:void(0)" id="{{ $notice->id }}">
                                ...
                                @can('notice.delete')
                                <a class="delete delete-icon" href="javascript:void(0)" data-id="{{ $notice->id }}">
                                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
