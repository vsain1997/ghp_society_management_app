            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <div class="custom_form">
                        <form method="POST" action="{{ route($thisModule . '.sos_category.store') }}" id="addSosCategoryForm"
                            ...
                            <div id="emer_block" class="mb-4">
                                <div class="row" data-sl="1">
                                    <div class="col-10">
                                        ...
                                        <input type="text" name="action_name[1]" class="form-control">
                                        <span class="text-danger err"></span>
                                    </div>
                                    <div class="col-2">
                                        <a href="javascript:void(0)" id="add_emer_row" class="add-more-btn">+
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="emer_block2" class="mb-4">
                                <div class="row add-remove-btn" data-sl="1">
                                    <div class="col-5">
                                        <label>Name</label>
                                    ...
                                    <div class="col-2 pt-3">
                                        <a href="javascript:void(0)" id="add_emer_row2" class="add-more-btn">+
                                        </a>
                                    </div>
                                </div>
                            </div>
...
@push('footer-script')
                            ...
                            if (sl == 1) {
                                ...
                                <div class="row" data-sl="${sl}">
                                    <div class="col-10">
                                        ...
                                        <input type="text" name="action_name[${sl}]" value="${action.name}" class="form-control">
                                        <span class="text-danger err"></span>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                                <a href="javascript:void(0)" class="btn btn-danger remove_emer_row mt-2">-</a>
                                                </div>
                                                </div>
                                                </div>`;
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#add_emer_row', function() {
                ...
                <div class="row" data-sl="${sl}">
                    <div class="col-10">
                        <input type="hidden" name="action_id[${sll}]" value="">
                        <input type="text" name="action_name[${sl}]" class="form-control">
                        <span class="text-danger err"></span>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            <a href="javascript:void(0)"
                                class="btn btn-danger remove_emer_row mt-2">-
                            </a>
                        </div>
                    </div>
                </div>`;
            ...
            $(document).on('click', '#add_emer_row2', function() {
                ...
                let emer_html = `
                    <div class="row" data-sl="${sl}">
                         <div class="col-5">
                            <input type="hidden" name="em_id[${sll}]" value="">
