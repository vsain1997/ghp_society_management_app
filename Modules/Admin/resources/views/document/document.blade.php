                            ...
                            <div class="filter-box">
                                <div class="filter-secl">
                                    ...
                                    <select name="request_type" class="form-control">
                                        ...
                                        <option value="ownself_request"
                                            {{ request('request_type') == 'ownself_request' ? 'selected' : '' }}>Ownself
                                        </option>
                    ...
                    <thead>
                        <tr>
                            @if (!empty(request('request_type')))
                                @if (request('request_type') == 'residents_request' || request('request_type') == 'management_request')
                                    <th class="text-center">Request From</th>
                                    <th class="text-center">Phone</th>
                                @elseif (request('request_type') == 'ownself_request')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            @if ($request->request_by_role == 'admin')
                                                        ...
                                                        <defs>
                                                            <clipPath id="clip0_193_2091">
                                                                <rect width="16" height="16" fill="white"
                                                                    transform="translate(0 0.68158)"></rect>
                                                            </clipPath>
                                                        </defs>
                                                    </svg>
                                                </a>
                                            @endif
                                            @can('document.upload_send')
                                                @if ($request->status != 'uploaded' && $request->request_by_role == 'resident')
                                                    <a class="edit edit-icon uplaod_file_btn" href="javascript:void(0)"
