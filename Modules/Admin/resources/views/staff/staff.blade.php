                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="actions">
                                @if ($staff->daily_help)
                                <a class="" title="Assign To Member" href="javascript:void(0)"
                                    data-user-id="{{ $staff->user_id }}" data-bs-toggle="modal"
                                    data-bs-target="#assignMember">
                                    <i class="fa-solid fa-user-plus" style="color:#8077f5"></i>
                                </a>
                                @endif
                                @can('staff.edit')
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <div class="custom_form">
                    <form method="POST" action="{{ route($thisModule . '.staff.store') }}" id="addStaffForm"
                        ...
                        <div class="row" id="daily_help_block">
                            <div class="form-check d-inline-flex" style="margin-left: 11px;">
                                <input type="checkbox" name="daily_help" id="daily_help" class="form-check-input"
                                    style="width: 6%;height:48px;border-radius: 10px !important;">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-grooup">
                                    ...
                                    <select name="off_days[]" id="off_days" class="form-select form-control days"
                                        multiple>
...
<div class="modal fade custom_Modal" id="assignMember" tabindex="-1" aria-labelledby="assignMemberLabel"
    aria-hidden="true" data-staff-user-id="" data-bs-backdrop="static" data-bs-keyboard="false">
                ...
                <div class="container">
                    <form method="POST" action="{{ route($thisModule . '.staff.assignMember') }}" id="assignMemberForm">
                        ...
                        <div class="save-close-btn pt-4">
                            <button type="button" class="close-btn cancel_btn" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="bg_theme_btn" id="assignMemberFormBtn">Assign</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $('body').on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#id').val(data.id);
                    $('#daily_help_block').hide();
                    if (data.role !== 'staff_security_guard' && data.role !== 'staff') {
                        $('#daily_help_block').show();
                    }
