...
@section('content')
    <div class="right_main_body_content society_detail_page">
        <div class="head_content">
            <div class="left_head">
                <h2>
                    <a href="{{ route($thisModule . '.society.resident_unit.index') }}">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        @php
                            ...
                            $getInfo = \App\Models\Block::select('unit_size')
                                ->where('society_id', $society_id)
                                ->where('name', $data->block_name)
                                // ->where('floor', $units['floor_number'])
                                ->where('unit_type', $data->unit_type)
                                ->first();
                        @endphp
