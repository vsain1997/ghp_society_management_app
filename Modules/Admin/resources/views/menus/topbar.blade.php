@php
    $pageHeading = '';
    $activeClass = '';
    // Check if the current route prefix is 'notice'
    if (request()->is($thisModule . '/notice*')) {
        $pageHeading = 'Notice Board';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/dashboard*')) {
        $pageHeading = 'Dashboard';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/society/properties*')) {
        $pageHeading = 'Society Properties';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/visitor')) {
        $pageHeading = 'Resident Visitors';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/visitor-other')) {
        $pageHeading = 'Other Visitors';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/poll*')) {
        $pageHeading = 'Polls';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/event*')) {
        $pageHeading = 'Events';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/complaints-category*')) {
        $pageHeading = 'Complaints Category';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/sos-category*')) {
        $pageHeading = 'SOS Category';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/sos')) {
        $pageHeading = 'SOS';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/staff*')) {
        $pageHeading = 'Staffs';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/complaint')) {
        $pageHeading = 'Complaints';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/member')) {
        $pageHeading = 'Members';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/service-provider')) {
        $pageHeading = 'Service Providers';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/service-provider-category')) {
        $pageHeading = 'Service Category';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/property-listing')) {
        $pageHeading = 'Property Listings';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/billing')) {
        $pageHeading = 'Billing';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/refer-property')) {
        $pageHeading = 'Refer Property';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/document')) {
        $pageHeading = 'Documents';
        $activeClass = 'active';
    } elseif (request()->is($thisModule . '/parcel*')) {
        $pageHeading = 'Parcels';
        $activeClass = 'active';
    }
@endphp
