...
class checkResidentSecurityGuardCommonApiAuth
{
    /**
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        // Check if token is valid and authenticated & user is a resident or staff
        if (Auth::guard('sanctum')->check()) {
            $user = Auth::guard('sanctum')->user();

            if ($user->role == 'resident' || $user->role == 'staff' || $user->role == 'staff_security_guard' || $user->role == 'admin') {
